    ...
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <div className={styles.savedFrom}>
          <img src={scheduleIcon} alt="" className={styles.savedIcon} />
        ...
        <div className={styles.list}>
          {saved.length === 0 ? (
            <p className={styles.empty}>No artists saved yet. Heart some in Lineup!</p>
          ) : (
        ...
        <button className={styles.addButton} onClick={() => navigate("/lineup")}>
